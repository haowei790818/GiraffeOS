...
//
#define GIRAFFEOS_TYPE 40000
//
// The IOCTL function codes from 0x800 to 0xFFF are for customer use.
//
#define IOCTL_GIRAFFEOS_METHOD_IN_DIRECT \
	CTL_CODE( GIRAFFEOS_TYPE, 0x900, METHOD_IN_DIRECT, FILE_ANY_ACCESS  )

#define IOCTL_GIRAFFEOS_METHOD_OUT_DIRECT \
	CTL_CODE( GIRAFFEOS_TYPE, 0x901, METHOD_OUT_DIRECT , FILE_ANY_ACCESS  )

#define IOCTL_GIRAFFEOS_METHOD_BUFFERED \
	CTL_CODE( GIRAFFEOS_TYPE, 0x902, METHOD_BUFFERED, FILE_ANY_ACCESS  )

#define IOCTL_GIRAFFEOS_METHOD_NEITHER \
	CTL_CODE( GIRAFFEOS_TYPE, 0x903, METHOD_NEITHER , FILE_ANY_ACCESS  )

#define IOCTL_GIRAFFEOS_METHOD_APPLY_SETTING \
	CTL_CODE( GIRAFFEOS_TYPE, 0x904, METHOD_NEITHER , FILE_ANY_ACCESS  )
